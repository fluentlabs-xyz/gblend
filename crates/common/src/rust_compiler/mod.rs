use foundry_compilers::{
    artifacts::{
        ...
        Severity, Sources,
    }, solc::Restriction, CompilationError, Compiler,
...
pub struct RustWasmParser;

impl SourceParser for RustWasmParser {
...
impl ParsedSource for RustWasmParsedSource {
    ...
    fn parse(_content: &str, file: &Path) -> foundry_compilers::error::Result<Self> {
